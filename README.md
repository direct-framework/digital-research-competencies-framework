...
[![Watch the video of project lead Dave Horsfall describing the DIRECT Framework, how it identifies skills and defines development pathways for anyone working in research software, serving as an important tool to help with career progression](https://raw.githubusercontent.com/direct-framework/digital-research-competencies-framework/images/promo-video-screenshot.png?raw=true)](https://www.youtube.com/watch?v=NpQFhwqBgg4)
